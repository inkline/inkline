...
import { GeneratorOutput, GeneratorPriority, ThemeVariable } from '../types';
...
export const breakpointsResolver = defineResolver<RawThemeBreakpoint, ResolvedThemeBreakpoint>({
    key: /^breakpoints\.[^.]+$/,
