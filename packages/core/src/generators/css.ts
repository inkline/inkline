import { isCalc, isColor, isAtRule, isRef, isSelector, isTheme, isVariable } from '../typeGuards';
import {
    Calc,
    Color,
    AtRule,
...
import { indentLines, normalizePercentageValue, normalizeTokenName, toCssName } from '../utils';
...
${indentLines(consumeComponentValue(instance.__value))}
}`;
}
