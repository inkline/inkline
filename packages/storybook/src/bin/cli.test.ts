...
describe("resolveOptions", () => {
  it("falls back to the conventional monorepo paths", () => {
    expect(resolveOptions({ watch: false }, "/repo/packages/storybook")).toEqual({
...
describe("runCli", () => {
  ...
  it("generates once and logs a summary", async () => {
    ...
    expect(deps.generate).toHaveBeenCalledWith({
      coreStoriesDir: "/repo/packages/storybook/d",
      uiDir: "/repo/packages/storybook/u",
    });
