...
import { isFocusable, isFunction, isKey, uid, getValueByPath } from '../../helpers';
import { colorVariantClass, defaultPropValue, sizePropValidator, FormComponentMixin, PopupMixin } from '../../mixins';
import { useBaseModifiers, sameWidthModifier } from '../../mixins/PopupMixin';
import { ClickOutside } from '../../directives';
import IInput from '../IInput/index.vue';
import IIcon from '../IIcon/index.vue';
import IMark from '../IMark/index.vue';
import ISelectOption from './components/ISelectOption/index.vue';
/**
 * @name prefix
 * @kind slot
