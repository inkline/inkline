...
The full rationale, including why the surface is borrowed from Solid rather than written by hand, is [ADR-002](./adrs/002-typed-jsx-intrinsic-elements-derived-from-solid.md).
