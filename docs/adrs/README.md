...
| [008](./008-emitted-output-is-typechecked-in-the-unit-suite.md)       | Emitted output is typechecked in the unit suite, behind a poison test   | 2026-08-11 | Proposed   | compiler, testing, ci     |
