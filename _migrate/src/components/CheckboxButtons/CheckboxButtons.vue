...
import { RenderResolver, CheckableButtonGroup } from '@inkline/inkline/components/utils';
import type { CheckboxButtonOption } from '@inkline/inkline/components/CheckboxButtons/types';

const componentName = 'CheckboxButtons';
    ...
    >
        ...
        >
            ...
            <slot name="option" :option="option">
                <RenderResolver :render="option.label ?? label" :ctx="option" />
            </slot>
        </Button>
