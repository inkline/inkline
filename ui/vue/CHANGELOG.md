...
- 24df22c: fix: emit `dist/index.css` so the `./css` subpath export resolves
...
- c12188d: fix(compiler): Vue no longer collapses multi-child fragments into an inert `<template>`
