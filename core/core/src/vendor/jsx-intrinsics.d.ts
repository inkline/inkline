...
/**
 * VENDORED — DO NOT EDIT. Everything below this header is byte-identical to upstream.
 *
 ...
 *
 * Vendored rather than depended on because `solid-js` is a runtime package and `@inkline/core`
 * ships no runtime. See ./README.md for the rationale and the full re-sync procedure.
 *
 ...
 * not honour suppression comments. Both exit 0, so this is noise, not a gate. Living with it beats
 * the alternatives: editing the body would break the re-sync diff, and adding the file to
