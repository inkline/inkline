...
const routes = [
    ...
    { name: 'docs-forms-form-validation', path: '/docs/forms/form-validation', component: () => import('../docs/forms/validation/en.md') },
    { name: 'docs-forms-form-validation-schema', path: '/docs/forms/form-validation/schema', component: () => import('../docs/forms/validation/schema/en.md') },
    { name: 'docs-forms-form-validation-validators', path: '/docs/forms/form-validation/validators', component: () => import('../docs/forms/validation/validators/en.md') },
    { name: 'docs-forms-form-validation-methods', path: '/docs/forms/form-validation/methods', component: () => import('../docs/forms/validation/methods/en.md') },
