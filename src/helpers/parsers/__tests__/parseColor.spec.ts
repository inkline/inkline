    ...
    describe('parsers', () => {
        describe('parseColor', () => {
            it('should return hsla color object from color string', () => {
                ...
                expect(parseColor(config, value)).toEqual({ h: 0, s: 100, l: 50, a: 1 });
            });
            ...
            it('should return hsla color object from hex string', () => {
                ...
                expect(parseColor(config, value)).toEqual({ h: 0, s: 0, l: 100, a: 1 });
            });
            ...
            it('should return hsla color object from hsla string', () => {
                ...
                expect(parseColor(config, value)).toEqual({ h: 0, s: 0, l: 0, a: 1 });
            });
