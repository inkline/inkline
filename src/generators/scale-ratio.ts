...
export const scaleRatioGenerator: Generator<ResolvedTheme['scaleRatio']> = {
    ...
    apply: ({ value }) => {
        return ['/**', ' * Scale ratio variables', ' */'].concat(
            Object.keys(value)
            ...
            [
                ...
                codegenSetCSSVariable(
                    'scale-ratio-pow-2',
                    'calc(var(--scale-ratio-pow-1) * var(--scale-ratio))'
                ),
                codegenSetCSSVariable(
                    'scale-ratio-pow-3',
                    'calc(var(--scale-ratio-pow-2) * var(--scale-ratio))'
                ),
                codegenSetCSSVariable(
                    'scale-ratio-pow-4',
                    'calc(var(--scale-ratio-pow-3) * var(--scale-ratio))'
                ),
                codegenSetCSSVariable(
                    'scale-ratio-pow-5',
                    'calc(var(--scale-ratio-pow-4) * var(--scale-ratio))'
                ),
                codegenSetCSSVariable(
                    'scale-ratio-pow-6',
                    'calc(var(--scale-ratio-pow-5) * var(--scale-ratio))'
                )
            ]
        );
    }
...
export const scaleRatioGenerators = [scaleRatioGenerator];
