    ...
    describe('scaleRatio.[name]', () => {
        describe('test', () => {
            it('should match direct path', () => {
                ...
                expect((scaleRatioResolver.test as RegExp).test(path)).toEqual(true);
            });
        ...
        describe('set', () => {
            it('should replace direct path', () => {
                const path = 'scaleRatio.golden';
                expect(path.replace(scaleRatioResolver.test as RegExp, scaleRatioResolver.set as string)).toEqual('scaleRatio.golden');
            });

            it('should replace nested path', () => {
                const path = 'nested.scaleRatio.golden';
                expect(path.replace(scaleRatioResolver.test as RegExp, scaleRatioResolver.set as string)).toEqual('nested.scaleRatio.golden');
            });
        });
