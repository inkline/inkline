    ...
    contents = contents
        ...
        .map((line) => {
            ...
            return line
                .replace(
                    'var(----line-height)',
                    `var(--${componentName}--line-height, var(--line-height))`
                )
                .replace(
                    'var(--transition-duration)',
                    `var(--${componentName}--transition-duration, var(--transition-duration))`
                )
                .replace(
                    'var(--transition-easing)',
                    `var(--${componentName}--transition-timing-function, var(--transition-timing-function))`
                )
                .replace(
                    /transition-property: (.+);/,
                    `transition-property: var(--${componentName}--transition-property, ($1));`
                )
                ...
                .replace(
                    ...
                    `var(--${componentName}--disabled--background)`
                )
                .replace(
                    'var(----border-color--disabled)',
                    `var(--${componentName}--disabled--border-color)`
                )
                .replace(
                    'var(----font-size)',
                    `var(--${componentName}--font-size, var(--font-size))`
                )
                .replace(
                    'var(----border-top-width)',
                    `var(--${componentName}--border-top-width, var(--border-top-width))`
                )
                .replace(
                    'var(----border-right-width)',
                    `var(--${componentName}--border-right-width, var(--border-right-width))`
                )
                .replace(
                    'var(----border-bottom-width)',
                    `var(--${componentName}--border-bottom-width, var(--border-bottom-width))`
                )
                .replace(
                    'var(----border-left-width)',
                    `var(--${componentName}--border-left-width, var(--border-left-width))`
                )
                .replace(
                    'var(----border-width)',
                    `var(
...
${indent})`
                ...
                .replace(
                    ...
                    `var(--${componentName}--border-top-style, var(--border-top-style))`
                )
                .replace(
                    'var(----border-right-style)',
                    `var(--${componentName}--border-right-style, var(--border-right-style))`
                )
                .replace(
                    'var(----border-bottom-style)',
                    `var(--${componentName}--border-bottom-style, var(--border-bottom-style))`
                )
                .replace(
                    'var(----border-left-style)',
                    `var(--${componentName}--border-left-style, var(--border-left-style))`
                )
                .replace(
                    'var(----border-style)',
                    `var(
...
${indent})`
                ...
                .replace(
                    ...
                    `var(--${componentName}--border-top-color, var(--border-top-color))`
                )
                .replace(
                    'var(----border-right-color)',
                    `var(--${componentName}--border-right-color, var(--border-right-color))`
                )
                .replace(
                    'var(----border-bottom-color)',
                    `var(--${componentName}--border-bottom-color, var(--border-bottom-color))`
                )
                .replace(
                    'var(----border-left-color)',
                    `var(--${componentName}--border-left-color, var(--border-left-color))`
                )
                .replace(
                    'var(----border-color)',
                    `var(
...
${indent})`
                ...
                .replace(
                    ...
                    `var(--${componentName}--border-top-left-radius, var(--border-top-left-radius))`
                )
                .replace(
                    'var(----border-top-right-radius)',
                    `var(--${componentName}--border-top-right-radius, var(--border-top-right-radius))`
                )
                .replace(
                    'var(----border-bottom-right-radius)',
                    `var(--${componentName}--border-bottom-right-radius, var(--border-bottom-right-radius))`
                )
                .replace(
                    'var(----border-bottom-left-radius)',
                    `var(--${componentName}--border-bottom-left-radius, var(--border-bottom-left-radius))`
                )
                .replace(
                    'var(----border-radius)',
                    `var(
...
${indent})`
                ...
                .replace(
                    'var(----padding-top)',
                    `var(--${componentName}--padding-top, var(--padding-top))`
                )
                .replace(
                    'var(----padding-right)',
                    `var(--${componentName}--padding-right, var(--padding-right))`
                )
                .replace(
                    'var(----padding-bottom)',
                    `var(--${componentName}--padding-bottom, var(--padding-bottom))`
                )
                .replace(
                    'var(----padding-left)',
                    `var(--${componentName}--padding-left, var(--padding-left))`
                )
                .replace(
                    'var(----padding)',
                    `var(
...
${indent})`
                ...
                .replace(
                    'var(----margin-top)',
                    `var(--${componentName}--margin-top, var(--margin-top))`
                )
                .replace(
                    'var(----margin-right)',
                    `var(--${componentName}--margin-right, var(--margin-right))`
                )
                .replace(
                    'var(----margin-bottom)',
                    `var(--${componentName}--margin-bottom, var(--margin-bottom))`
                )
                .replace(
                    'var(----margin-left)',
                    `var(--${componentName}--margin-left, var(--margin-left))`
                )
                .replace(
                    'var(----margin)',
                    `var(
...
${indent})`
                ...
                .replace(
                    'var(----header--color)',
                    `var(--${componentName}--header--color, var(--${componentName}--color))`
                )
                .replace(
                    'var(----body--color)',
                    `var(--${componentName}--body--color, var(--${componentName}--color))`
                )
                .replace(
                    'var(----footer--color)',
                    `var(--${componentName}--footer--color, var(--${componentName}--color))`
                )
                .replace(
                    'var(----header--background)',
                    `var(--${componentName}--header--background, var(--${componentName}--background))`
                )
                .replace(
                    'var(----body--background)',
                    `var(--${componentName}--body--background, var(--${componentName}--background))`
                )
                .replace(
                    'var(----footer--background)',
                    `var(--${componentName}--footer--background, var(--${componentName}--background))`
                )
                .replace(
                    'var(----header--margin-bottom)',
                    `var(--${componentName}--header--margin-bottom, var(--${componentName}--margin-bottom, var(--margin-bottom)))`
                )
                .replace(
                    'var(----footer--margin-top)',
                    `var(--${componentName}--footer--margin-top, var(--${componentName}--margin-top, var(--margin-top)))`
                );
        })
        .join('\n');
