...
import { toRef, provide, computed, inject, ref, useSlots, onMounted, onBeforeUnmount, PropType} from 'vue';
...
const { visible, hide, show, onKeyEscape, focusTrigger, onClick, onClickOutside } = usePopupControl({
    triggerRef,
    popupRef,
    arrowRef,
    componentProps,
