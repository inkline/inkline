            ...
            describe('validation', () => {
                describe('alpha', () => {
                    it('should find and translate given path', () => {
                        ...
                        expect(translate('validation.alpha', params)).toEqual(
                            (en.validation as any).alpha(params)
                        );
                    });
                ...
                describe('alphanumeric', () => {
                    it('should find and translate given path', () => {
                        ...
                        expect(translate('validation.alphanumeric', params)).toEqual(
                            (en.validation as any).alphanumeric(params)
                        );
                    });
                ...
                describe('number', () => {
                    it('should find and translate given path', () => {
                        ...
                        expect(translate('validation.number', params)).toEqual(
                            (en.validation as any).number(params)
                        );
                    });
                ...
                [
                    ...
                    describe(validator, () => {
                        it('should find and translate given path', () => {
                            ...
                            expect(translate(`validation.${validator}`, params)).toEqual(
                                (en.validation as any)[validator]
                            );
                        });
                    });
                });
