            ...
            describe("validation", () => {
                ...
                describe("alphanumeric", () => {
                    it("should find and translate given path", () => {
                        ...
                        expect(
                            translate("validation.alphanumeric", params)
                        ).toEqual((en.validation as any).alphanumeric(params));
                    });
                ...
                [
                    ...
                    describe(validator, () => {
                        it("should find and translate given path", () => {
                            ...
                            expect(
                                translate(`validation.${validator}`, params)
                            ).toEqual((en.validation as any)[validator]);
                        });
                    });
                });
            });
