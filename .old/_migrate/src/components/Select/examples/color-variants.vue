...
<template>
    <Select v-model="selected" :options="options" placeholder="Choose something.." color="light" />

    <Select v-model="selected" :options="options" placeholder="Choose something.." color="dark" />
</template>
