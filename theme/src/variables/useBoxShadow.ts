...
export function useBoxShadowVariables(userOptions: DefinitionOptions) {
    ...
    const boxShadowOffsetXMd = variable('box-shadow-offset-x--md', 0, options);
    const boxShadowOffsetYMd = variable('box-shadow-offset-y--md', '0.5rem', options);
    const boxShadowBlurRadiusMd = variable('box-shadow-blur-radius--md', '1rem', options);
    const boxShadowSpreadRadiusMd = variable('box-shadow-spread-radius--md', '-0.75rem', options);
    const boxShadowColorMd = variable('box-shadow-color--md', 'rgba(0, 0, 0, 0.15)', options);
